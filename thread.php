...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            <h4 class="display-8"><?php echo $title;?></h4>
            ...
            <p class="mb-4">Posted by: <em><?php echo $posted_by; ?></em></p>
        </div>
    </div>
    ...
    echo '<div class="container">
        ...
        <form action= "'. $_SERVER['REQUEST_URI'] . '" method="post"> 
            <div class="form-group">
                <label for="exampleFormControlTextarea1 mb-2">Type your comment</label>
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="media my-3">
            <img src="img/default-user.png" width="54px" class="mr-3" alt="...">
